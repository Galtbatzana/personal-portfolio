...
export function Experience () {
    return (
        <div className="mx-auto sm:w-[375px] lg:w-[1440px] bg-[#F9FAFB] dark:bg-[#111827]">
            <div className="mx-auto lg:w-[1216px] sm-[343px] flex-col text-center justify-center pt-12">
                    <p className="bg-[#E5E7EB] text-[#4B5563] px-[20px] py-2 inline text-sm font-medium rounded-[12px] dark:bg-[#374151] dark:text-[#D1D5DB]">
                        Experiences
                    </p>
                    <p className="mt-8 sm:mx-10 text-[#4B5563] dark:text-white">
