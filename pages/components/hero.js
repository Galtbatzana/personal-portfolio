    ...
    return (
        <div className="mx-auto sm:w-[375px] lg:w-[1440px] bg-white">
            <div className="mx-auto sm:w-[375px] lg:w-[1280px]">
                <div className="lg:flex justify-between lg:mx-20 lg:py-[96px] bg-white gap-12">
                    ...
                    <div className="lg:order-1 lg:w-[768px] p-4">
                        <div className="flex items-center gap-2">
                                <h1 className="font-bold sm:text-[36px] lg:text-[60px] text-[#111827]">
                                    Hi, I'm Sagar
                                </h1>
                                <Handwaving />              
                        </div>
                        <div className="text-[#4B5563] mb-[48px]">
